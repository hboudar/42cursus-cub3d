...
int main()
{
    ...
    file[2] = strdup("1111100011111111111111111");
    ...
    file[8] = strdup("11111111111111111111111111111111111111111N");
    file[9] = strdup("111101111111110111010100100011");
    file[10] =strdup( "11000000111101011100000010001");
    file[11] =strdup( "10000000011000001100000010001");
    file[12] =strdup( "1000000001000001101010011001");
